            ...
            <form action="/announcement/update" method="POST" class="max-w-2xl mt-4" id="updateAnnouncement"
                    ...
                    <div class="mt-2">
                        <div>
                            <input type="radio" name="isActive" id="isActiveYes" value="1"
                                   @checked($announcement->isActive) required>
                ...
                <div class="mt-4">
                    ...
                    <input type="text" name="bannerText" id="bannerText"
                           class="border border-gray-400 rounded w-full px-2 py-2 mt-2"
                           value="{{ $announcement->bannerText }}" required>
                </div>

                <div class="mt-4">
                    <label for="bannerColor" class="font-semibold block">Banner Color</label>
                    <input type="color" name="bannerColor" id="bannerColor" value="{{ $announcement->bannerColor }}"
                           required>
                </div>

                <div class="mt-4">
                    <label for="titleText" class="font-semibold block">Title Text</label>
                    <input type="text" name="titleText" id="titleText"
                           class="border border-gray-400 rounded w-full px-2 py-2 mt-2"
                           value="{{ $announcement->titleText }}" required>
                </div>

                <div class="mt-4">
                    <label for="titleColor" class="font-semibold block">Title Color</label>
                    <input type="color" name="titleColor" id="titleColor" value="{{ $announcement->titleColor }}"
                           required>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <input type="text" name="buttonText" id="buttonText"
                           class="border border-gray-400 rounded w-full px-2 py-2 mt-2"
                           value="{{ $announcement->buttonText }}" required>
                </div>

                <div class="mt-4">
                    <label for="buttonColor" class="font-semibold block">Button Color</label>
                    <input type="color" name="buttonColor" id="buttonColor" value="{{ $announcement->buttonColor }}"
                           required>
                </div>

                <div class="mt-4">
                    <label for="buttonLink" class="font-semibold block">Button Link</label>
                    <input type="url" name="buttonLink" id="buttonLink"
                           class="border border-gray-400 rounded w-full px-2 py-2 mt-2"
                           value="{{ $announcement->buttonLink }}" required>
                </div>
